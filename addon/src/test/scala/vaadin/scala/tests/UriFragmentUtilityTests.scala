...
class UriFragmentUtilityTests extends FunSuite with BeforeAndAfter with MockitoSugar {
  ...
  class VaadinUriFragmentUtility extends com.vaadin.ui.UriFragmentUtility with UriFragmentUtilityMixin

  var uriFragmentUtility: UriFragmentUtility = _
  var spy: VaadinUriFragmentUtility = _

  before {
    val vaadinUriFragmentUtility = new VaadinUriFragmentUtility
