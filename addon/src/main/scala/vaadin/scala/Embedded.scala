...
class Embedded(implicit wrapper: WrapperRegistry) extends AbstractComponent {

  override val p = new com.vaadin.ui.Embedded

  def this(caption: String = null, width: Option[Measure] = None, height: Option[Measure] = None, source: Resource = null, objectType: Embedded.Type.Value = Embedded.Type.objectType, style: String = null)(implicit wrapper: WrapperRegistry) = {
    this()
  ...
  def source: Option[Resource] = wr.get[Resource](p.getSource)
